...
The code below is used to prepare the choroplethby using the *qtm()* function of **tmap** package.
...
Now let us plot the choropleth maps showing the dsitribution of total number of households and Radio penetration rate by using the code below.
...
The `dist()` function supports 6 types of distance calculations: 
- Euclidean, 
- Maximum, 
- Manhattan, 
- Canberra, 
...
1. use
[*cutree()*](https://stat.ethz.ch/R-manual/R-devel/library/stats/html/cutree.html) of R Base to derive a 6-cluster model
...
To reveal the distribution of a clustering variable (i.e RADIO_PR) by clusterL
